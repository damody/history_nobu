...
function Nobu:OnItemPurchased( keys )
  ...
  GameRules: SendCustomMessage("purchase " .. #_G.purchased_itmes_time, DOTA_TEAM_GOODGUYS + DOTA_TEAM_BADGUYS,0)
  GameRules: SendCustomMessage("purchase " .. #_G.purchased_itmes_time[playerID], DOTA_TEAM_GOODGUYS + DOTA_TEAM_BADGUYS,0)
  GameRules: SendCustomMessage("purchase " .. #_G.purchased_itmes_time[playerID][keys.itemname], DOTA_TEAM_GOODGUYS + DOTA_TEAM_BADGUYS,0)
