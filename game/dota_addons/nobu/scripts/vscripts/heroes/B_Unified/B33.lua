...
function B33T( keys )
	...
	EmitSoundOnLocationWithCaster(keys.caster:GetAbsOrigin(),"broodmother_broo_immort_01",keys.caster)
	EmitSoundOnLocationWithCaster(dummy:GetAbsOrigin(),"broodmother_broo_win_01",dummy)
	Physics:Unit(dummy)
