...
function Burn( keys )
	...
	for i,v in ipairs(group) do
		if v:CanEntityBeSeenByMyTeam(caster) and not caster:IsIllusion() and not caster:HasModifier("modifier_invisible") and not v:HasModifier("modifier_B13E_sleep") then
